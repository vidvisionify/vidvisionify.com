...
I'd love if the various console homebrew communities embraced this software, making file transfer and save management so much easier. Some consoles it would make more sense

Honestly anything that you can reasonably connect to the internet but of note:

- **3DS** - While 3DS games can be somewhat large, could still be useful with _Checkpoint_ and managing saves. Could also transfer GBA/SNES games.
- **Wii**
